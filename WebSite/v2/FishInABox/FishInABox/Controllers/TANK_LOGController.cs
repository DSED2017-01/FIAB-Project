...
namespace FishInABox.Controllers
{
    public class TANK_LOGController : Controller
    {
        ...
        {
            var tANK_LOG = db.TANK_LOG.Include(t => t.MOVEMENT_PERIOD).Include(t => t.TANK).Include(t => t.SYS_STUFF);
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID_PK,PERIOD_FK,TANK_FK,SPECIES_FK,SPECIES_TEXT,SPECIES_TEXT_2,QTY,COMMENT,STUFF_FK")] TANK_LOG tANK_LOG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID_PK,PERIOD_FK,TANK_FK,SPECIES_FK,SPECIES_TEXT,SPECIES_TEXT_2,QTY,COMMENT,STUFF_FK")] TANK_LOG tANK_LOG)
        {
            if (ModelState.IsValid)
            {
